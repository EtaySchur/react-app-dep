...
// const ModernLanguageRegistration: React.FC = () => {
...
//   const createCustomLanguage = (hljs?: any) => {
//     return {
...
//         const result = hljs.highlight(languageName, testCode);
...
//       <h3>Modern Language Registration (10.4.1+ APIs)</h3>
      
//       <div className="registration-controls">
//         <div className="input-group">
//           <label htmlFor="modern-lang-name">Custom Language Name:</label>
//           <input 
//             id="modern-lang-name"
//             type="text"
...
// export default ModernLanguageRegistration; 